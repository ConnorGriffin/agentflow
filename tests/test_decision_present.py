...
from agentflow.coordinated_research import decision_line, decision_present, with_decision
...
def test_incidental_cross_reference_does_not_suppress_breadcrumb():
    ...
    updated = with_decision(body, decision_line("Audit the widget path", 5))
...
def test_own_written_line_is_recognised_as_replay():
    ...
    line = decision_line("Audit the widget path", 5)
    body = f"# Map\n\n## Decisions so far\n\n{line}\n"
